<template>
  <div class="view-container">
    ...
    <div v-else-if="groupedRecords.length === 0" class="card-container flex flex-col items-center justify-center py-10 text-gym-muted text-center gap-2">
    ...
    <div v-else class="space-y-6">
      ...
      <div v-for="group in groupedRecords" :key="group.key" class="space-y-3">
        <!-- Cabecera de Año -->
        <div class="sticky top-0 bg-gym-bg pt-2 pb-2 z-10">
          <h2 class="text-xl font-black text-gym-dark">{{ group.year }}</h2>
          <p class="text-sm font-bold text-gym-primary uppercase">{{ group.month }}</p>
        </div>
